  ...
  <xsl:template match="tei:figure[tei:graphic[@url]]" priority="99">
	...
	<xsl:template name="htmlHead">
		<head>
			...
			<script xmlns="http://www.w3.org/1999/xhtml" type="text/javascript"><!-- wfd: JS for switching text views -->
				function switchCustomCSS(theme) {
				document.getElementById('withtrans_css').href=theme.options[theme.selectedIndex].value;
}
			</script>
			<link xmlns="http://www.w3.org/1999/xhtml" id="notrans_css" rel="stylesheet" type="text/css" href="../css/custom_notrans.css" />
<link xmlns="http://www.w3.org/1999/xhtml" id="withtrans_css" rel="stylesheet" type="text/css" href="../css/custom_withtrans.css" />
  ...
  <xsl:template name="grab-css">
    ...
    <div>
			...
			<list>
			<item>Named entities (<blue>persons</blue>, <orange>places</orange>, <green>titles</green>) linked to <a style="color:black" href="https://library.bdrc.io/">BUDA</a>, <a style="color:black" href="https://www.istb.univie.ac.at/kanjur/">rKTs</a>, <a style="color:black" href="https://sakyaresearch.org/">SRC</a> and Tohoku catalogue (<a style="color:black" href="http://purl.bdrc.io/resource/MW1KG13833">Kanakura et al. 1953</a>)</item>
 			<item><b>headings</b> and <b>dates</b></item>
			<item>glosses {...}</item>
			<item>gaps [---]</item>
			<item>direct speech "..."</item>
			<item>corrections/regulations (=...)</item>
			<item><dashed>unclear</dashed></item>
			</list>
			</div>
			<div><h1>Text View</h1>
			<label for="pbToggle">Hide folios/pagination</label>
			<input type="checkbox" id="pbToggle" />
			</div>
			<p></p>
			<div><!-- wfd: select text view mode -->
				<h1>Translation</h1>
				<select xmlns="http://www.w3.org/1999/xhtml" style="display:inline;"
					id="themeBox" onchange="switchCustomCSS(this);">
					<option value="../css/custom_withtrans.css">Show translation</option>
					<option value="../css/custom_notrans.css">Hide translation</option>
				</select>
			</div>
<!-- 	 		<div>
				<h3>Themes:</h3>
...
<!--							<xsl:text>http://cloud.wdorner.com/images/beresford/thumbs/</xsl:text>
-->							<xsl:value-of select="@facs"/>
